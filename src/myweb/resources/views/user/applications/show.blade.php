...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4><i class="fas fa-file-alt me-2"></i>My Application</h4>
        ...
        <div class="card mb-4">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">
                    ...
                    Application for {{ $application->program->name }}
                </h5>
            </div>
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <strong>Deadline:</strong> {{ $application->program->deadline->format('M d, Y') }}
                    </div>
                    <div class="col-md-6">
                        ...
                        {{ $application->assignee->name ?? 'Not assigned yet' }}<br>
