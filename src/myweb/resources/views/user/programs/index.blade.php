<!-- resources/views/user/programs/index.blade.php -->
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4><i class="fas fa-graduation-cap me-2"></i>Available Scholarship Programs</h4>
</div>
            ...
            <div class="card-footer bg-transparent">
                <div class="d-flex justify-content-between">
                    ...
                    @if($program->is_open)
                        ...
                        @else
                            <a href="{{ route('applications.create', $program) }}" class="btn btn-sm btn-user">
...
<div class="text-center py-5">
    ...
    <p class="text-muted">Please check back later for new scholarship opportunities.</p>
</div>
@endif
@endsection